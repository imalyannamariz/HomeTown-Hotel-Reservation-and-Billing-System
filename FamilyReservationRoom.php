          ...
          <div class="col-md-8 col-sm-7 col-lg-8">
            <div class="rq-flex-slider">
              ...
              <div id="slider" class="flexslider">
                <ul class="slides">
                  <li>
                    <img src="./img/Family.jpg" alt="Slider Image" />
                  </li>
                  <li>
                    <img src="./img/Family1.jpg" alt="Slider Image" />
                  </li>
                  <li>
                    <img src="./img/Family2.jpg" alt="Slider Image" />
                  </li>
                  <li>
                    <img src="./img/Family3.jpg" alt="Slider Image" />
                  </li>
                  <li>
                    <img src="./img/Family4.jpg" alt="Slider Image" />
                  </li>
                  <li>
                    <img src="./img/Family5.jpg" alt="Slider Image" />
                  </li>
