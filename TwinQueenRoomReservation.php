            ...
            <div class="rq-single-room-checkin">
              ...
              <div class="rq-extra">
                <div class="rq-extra-content">
                  ...
                  <p><span>P 100 </span>/ Group / Trip</p>
                </div>
          ...
          <div class="col-md-8 col-sm-7 col-lg-8">
            <div class="rq-flex-slider">
              ...
              <div id="slider" class="flexslider">
                <ul class="slides">
                  <li>
                    <img src="./img/Twin.jpg" alt="Slider Image" />
                  </li>
                  <li>
                    <img src="./img/Twin1.jpg" alt="Slider Image" />
                  </li>
                  <li>
                    <img src="./img/Twin2.jpg" alt="Slider Image" />
                  </li>
                  <li>
                    <img src="./img/Twin3.jpg" alt="Slider Image" />
                  </li>
                  <li>
                    <img src="./img/Twin4.jpg" alt="Slider Image"/>
                  </li>
