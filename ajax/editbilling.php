...
mysqli_query($conn, "INSERT INTO financialreports_masterfile (payment, payment_type,created_at, billing_id) VALUES({$_POST['currentBalance']}, '{$status}','{$currentDay}', {$_POST['b_id']})") or die(mysqli_error($conn));
}
