              ...
              <div class="rq-listing-choose singleRoom-grid-main">
                <div class="row">
                  <div class="col-md-6 col-sm-12 singleRoom-grid-item">
                    <div class="thumbnail">
                      <picture>
                          <source media="(min-width: 768px)" srcset=img/Twin.jpg>
                  ...
                  <div class="col-md-6 col-sm-12 singleRoom-grid-item">
                    <div class="thumbnail">
                      <picture>
                          <source media="(min-width: 768px)" srcset=img/Family.jpg>
                          <img alt="Image" src="img/Family.jpg" srcset=img/Family.jpg>
                      </picture>
                      <div class="caption">
                        <h3><a href="FamilyReservationRoom.php">Family Room</a></h3>
                        <p>point of using that has more less normal distribution is among</p>
                        <div class="singleRoom-grid-main-custom">
                          <div class="row">
                            <h4><span>P 2,000 </span> / Night</h4>
                ...
                <div class="row">
                  <div class="col-md-6 col-sm-12 singleRoom-grid-item">
                    <div class="thumbnail">
                      <picture>
                          <source media="(min-width: 768px)" srcset=img/Queen.jpg>
                          <img alt="Image" src="img/Queen.jpg" srcset=img/Queen.jpg>
                      </picture>
                      <div class="caption">
                        <h3><a href="QueenReservationRoom.php">Queen Room</a></h3>
                        <p>point of using that has more less normal distribution is among</p>
                        <div class="singleRoom-grid-main-custom">
                          <div class="row">
                  ...
                  <div class="col-md-6 col-sm-12 singleRoom-grid-item">
                    <div class="thumbnail">
                      <picture>
                          <source media="(min-width: 768px)" srcset=img/Quad.jpg>
                          <img alt="Image" src="img/Quad.jpg" srcset=img/Quad.jpg>
                      </picture>
                      <div class="caption">
                        <h3><a href="QuadrupleReservationRoom.php">Quad Room</a></h3>
                        <p>point of using that has more less normal distribution is among</p>
                        <div class="singleRoom-grid-main-custom">
                          <div class="row">
                ...
                <div class="row">
                  <div class="col-md-6 col-sm-12 singleRoom-grid-item">
                    <div class="thumbnail">
                      <picture>
                          <source media="(min-width: 768px)" srcset=img/FMRoom.jpg>
                          <img alt="Image" src="img/FMRoom.jpg" srcset=img/FMRoom.jpg>
                      </picture>
                      <div class="caption">
                        <h3><a href="FemaleMaleReservationRoom.php">Female/Male Room</a></h3>
                        <p>point of using that has more less normal distribution is among</p>
                        <div class="singleRoom-grid-main-custom">
                          <div class="row">
                            <h4><span>P 499 </span> / Night</h4>
                            <h5> <a class="btn rq-btn-secondary" href="#" data-toggle="modal" data-target="#myModal">Book Now</a></h5>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="col-md-6 col-sm-12 singleRoom-grid-item">
                    <div class="thumbnail">
                      <picture>
                          <source media="(min-width: 768px)" srcset=img/Dorm.jpg>
                          <img alt="Image" src="img/Dorm.jpg" srcset=img/Dorm.jpg>
                      </picture>
                      <div class="caption">
                        <h3><a href="DormitoryReservationRoom.php">Dormitory Room</a></h3>
                        <p>point of using that has more less normal distribution is among</p>
                        <div class="singleRoom-grid-main-custom">
                          <div class="row">
                            <h4><span>P 400 </span> / Night</h4>
                            <h5> <a class="btn rq-btn-secondary" href="#" data-toggle="modal" 
                              data-target="#myModal">Book Now</a></h5>
                          </div>
                        </div>
                      </div>
                    </div>
