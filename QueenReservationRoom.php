          ...
          <div class="col-md-8 col-sm-7 col-lg-8">
            <div class="rq-flex-slider">
              ...
              <div id="slider" class="flexslider">
                <ul class="slides">
                  <li>
                    <img src="./img/Queen1.jpg" alt="Slider Image" />
                  </li>
                  <li>
                    <img src="./img/Queen2.jpg" alt="Slider Image" />
                  </li>
                  <li>
                    <img src="./img/Queen3.jpg" alt="Slider Image" />
                  </li>
                  <li>
                    <img src="./img/Queen4.jpg" alt="Slider Image" />
                  </li>
                </ul>
              </div>
